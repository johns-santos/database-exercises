...
#     titles in the titles table. Your results should look like:
...
USE employees;
SELECT DISTINCT last_name AS 'EMPLOYEE NAME'
from employees
...
# employees for each gender with those names. Your results should be:
SELECT CONCAT(gender, " ", count(*)) AS 'Sort By Gender'
FROM employees
